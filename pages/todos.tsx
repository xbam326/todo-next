...
const Todos = ({ data }: InferGetServerSidePropsType<typeof getServerSideProps>) => {
      ...
      <div className="w-full max-w-md mx-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="flex flex-col">
            ...
            <input ref={title} type="text" id="title" name="title" className="text-gray-700 border-gray-400 border rounded-lg p-2" placeholder="input title" required />
          </div>
          <div className="flex flex-col">
            <label htmlFor="description" className="font-semibold mb-1">description</label>
            <textarea ref={description} id="description" name="description" className="text-gray-700 border-gray-400 border rounded-lg p-2" placeholder="input description"></textarea>
          </div>
          <button type="submit" className="bg-blue-500 text-blue py-2 px-4 rounded-lg hover:bg-blue-600">create</button>
        </form>
      </div>
